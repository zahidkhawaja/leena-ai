...
[API routes](https://nextjs.org/docs/api-routes/introduction) can be accessed on [http://localhost:3000/api/leena](http://localhost:3000/api/leena). This endpoint can be edited in `pages/api/leena.js`.
