          ...
          <div className="bg-white rounded-lg p-6 max-w-lg w-full">
            ...
            <ul className="space-y-4">
              ...
              <li>
                ...
                <p>Just chat like you're texting a friend! Type whatever's on your mind in the box below. Leena's ready to listen and chat back. Leena also has the ability to run web searches to find you mental health resources in real-time. This feature allows her to provide up-to-date information on support groups, local therapists, and relevant articles tailored to your specific needs.</p>
              </li>
              <li>
